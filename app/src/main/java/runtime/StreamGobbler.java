...
public class StreamGobbler extends Thread {
    public static final String TAG = "StreamGobbler";
    ...
    public void run() {
        try {
            ...
            LogUtils.print(TAG, "streamType = " + streamType + ", ex = " + ex);
            Log.e("Failed to successfully consume and display the input stream of type " + streamType + ".", ex.toString());
        } finally {
            this.isStopped = true;
            synchronized (this) {
                notify();
